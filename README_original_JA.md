...
[English](README_original.md) | [中文](README_original_ZH.md) | 日本語 | [Deutsch](README_DE.md) | [Changelog](CHANGELOG.md) | [CC Switch Web（ヘッドレスサーバー）](README.md)
...
- **ConfigService**: 設定のインポート/エクスポート、バックプローテーション
- **SpeedtestService**: API エンドポイントのレイテンシ測定
...
- フォーマットチェック通過: `pnpm format:check`
- 単体テスト通過: `pnpm test:unit`

新機能の場合は、PR を送信する前に Issue で議論してください。プロジェクトに適さない機能の PR はクローズされる可能性があります。
