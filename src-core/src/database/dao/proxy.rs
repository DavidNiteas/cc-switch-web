...
use crate::proxy::types::{CircuitBreakerConfig, *};
...
pub fn validate_cost_multiplier(value: &str) -> Result<Decimal, AppError> {
...
pub fn validate_pricing_source(value: &str) -> Result<&str, AppError> {
    let trimmed = value.trim();
