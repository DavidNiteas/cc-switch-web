...
pub fn router(
    ...
    Router::new()
        ...
        .fallback(get(crate::web_assets::handler))
...
async fn invoke_handler(
    ...
    let result = match req.cmd.as_str() {
        ...
        "save_settings" => match req.args.get("settings") {
            Some(v) => {
                match serde_json::from_value::<cc_switch_core::settings::AppSettings>(v.clone()) {
        ...
        "save_provider" => {
            ...
            match req.args.get("provider") {
                Some(v) => {
                    match serde_json::from_value::<cc_switch_core::provider::Provider>(v.clone()) {
                        Ok(provider) => match cc_switch_core::commands::provider::save_provider(
                            &app_state,
                            &app,
                            provider,
        ...
        "get_custom_endpoints" => {
            ...
            let provider_id = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::provider::get_custom_endpoints(
                &app_state,
                &app,
                &provider_id,
            ) {
        ...
        "add_custom_endpoint" => {
            ...
            let url = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::provider::add_custom_endpoint(
                &app_state,
                &app,
                &provider_id,
                &url,
        ...
        "remove_custom_endpoint" => {
            ...
            let url = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::provider::remove_custom_endpoint(
                &app_state,
                &app,
                &provider_id,
                &url,
        ...
        "update_endpoint_last_used" => {
            ...
            let url = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::provider::update_endpoint_last_used(
                &app_state,
                &app,
                &provider_id,
                &url,
        ...
        "update_providers_sort_order" => {
            ...
            let updates = req
                ...
                .unwrap_or_default();
            match cc_switch_core::commands::provider::update_providers_sort_order(
                &app_state, &app, updates,
            ) {
                Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                Err(e) => Err(e.to_string()),
            }
        ...
        "upsert_universal_provider" => match req.args.get("provider") {
            Some(v) => match serde_json::from_value::<cc_switch_core::provider::UniversalProvider>(
                v.clone(),
            ) {
                Ok(provider) => {
                    match cc_switch_core::commands::provider::upsert_universal_provider(
                        &app_state, provider,
                    ) {
                        Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                        Err(e) => Err(e.to_string()),
        ...
        "import_opencode_providers_from_live" => {
            match cc_switch_core::commands::provider::import_opencode_providers_from_live(
                &app_state,
            ) {
                Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                Err(e) => Err(e.to_string()),
        ...
        "remove_provider_from_live_config" => {
            ...
            let id = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::provider::remove_provider_from_live_config(
                &app_state, &app, &id,
            ) {
                Ok(v) => Ok(Value::Bool(v)),
                Err(e) => Err(e.to_string()),
        ...
        "get_claude_desktop_default_routes" => Ok(serde_json::to_value(
            cc_switch_core::commands::provider::get_claude_desktop_default_routes(),
        )
        ...
        "import_claude_desktop_providers_from_claude" => {
            match cc_switch_core::commands::provider::import_claude_desktop_providers_from_claude(
                &app_state,
            ) {
                Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                Err(e) => Err(e.to_string()),
        ...
        "list_profiles" => match cc_switch_core::commands::profile::get_profiles(&app_state) {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        // ----- Settings 配置读写命令（10 个 A 类）-----
        "get_app_config_dir_override" => Ok(serde_json::to_value(
            cc_switch_core::commands::settings::get_app_config_dir_override(),
        )
        .unwrap_or(Value::Null)),
        ...
        "set_rectifier_config" => {
            ...
            match serde_json::from_value::<cc_switch_core::proxy::RectifierConfig>(config_value) {
                Ok(config) => match cc_switch_core::commands::settings::set_rectifier_config(
                    &app_state, config,
                ) {
                    Ok(v) => Ok(Value::Bool(v)),
                    Err(e) => Err(e.to_string()),
        ...
        "set_optimizer_config" => {
            ...
            match serde_json::from_value::<cc_switch_core::proxy::OptimizerConfig>(config_value) {
                Ok(config) => match cc_switch_core::commands::settings::set_optimizer_config(
                    &app_state, config,
                ) {
                    Ok(v) => Ok(Value::Bool(v)),
                    Err(e) => Err(e.to_string()),
        ...
        "set_copilot_optimizer_config" => {
            let config_value = req.args.get("config").cloned().unwrap_or(Value::Null);
            match serde_json::from_value::<cc_switch_core::proxy::CopilotOptimizerConfig>(
                config_value,
            ) {
                Ok(config) => {
                    match cc_switch_core::commands::settings::set_copilot_optimizer_config(
                        &app_state, config,
                    ) {
                        Ok(v) => Ok(Value::Bool(v)),
                        Err(e) => Err(e.to_string()),
        ...
        "get_log_config" => match cc_switch_core::commands::settings::get_log_config(&app_state) {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        "set_log_config" => {
            ...
            match serde_json::from_value::<cc_switch_core::proxy::LogConfig>(config_value) {
                Ok(config) => {
                    match cc_switch_core::commands::settings::set_log_config(&app_state, config) {
                        Ok(v) => Ok(Value::Bool(v)),
                        Err(e) => Err(e.to_string()),
                    }
                }
        ...
        "has_codex_unify_history_backup" => Ok(Value::Bool(
            cc_switch_core::commands::settings::has_codex_unify_history_backup(),
        )),
        ...
        "merge_deeplink_config" => {
            ...
            match serde_json::from_value::<cc_switch_core::deeplink::DeepLinkImportRequest>(
                request_value,
            ) {
                Ok(request) => {
                    match cc_switch_core::commands::deeplink::merge_deeplink_config(request) {
                        Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                        Err(e) => Err(e.to_string()),
                    }
                }
        ...
        "import_from_deeplink" => {
            ...
            match serde_json::from_value::<cc_switch_core::deeplink::DeepLinkImportRequest>(
                ...
                Ok(request) => match cc_switch_core::commands::deeplink::import_from_deeplink(
                    &app_state, request,
                ) {
        ...
        "import_from_deeplink_unified" => {
            ...
            match serde_json::from_value::<cc_switch_core::deeplink::DeepLinkImportRequest>(
                ...
                Ok(request) => {
                    match cc_switch_core::commands::deeplink::import_from_deeplink_unified(
                        &app_state, request,
                    )
                    .await
                    {
        ...
        "restore_skill_backup" => {
            ...
            let current_app = req
                ...
                .unwrap_or("claude")
                .to_string();
            match cc_switch_core::commands::skill::restore_skill_backup(
                &db,
                &backup_id,
                &current_app,
            ) {
        ...
        "get_skills" => match cc_switch_core::commands::skill::get_skills(&db).await {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        "get_skills_for_app" => {
        ...
        "install_skill_unified" => {
            ...
            let current_app = req
                ...
                .unwrap_or("claude")
                .to_string();
            match serde_json::from_value::<cc_switch_core::services::skill::DiscoverableSkill>(
                skill_value,
            ) {
                Ok(skill) => match cc_switch_core::commands::skill::install_skill_unified(
                    &db,
                    skill,
                    &current_app,
                )
        ...
        "install_skill_for_app" => {
            ...
            let directory = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::skill::install_skill_for_app(&db, &app, &directory)
                .await
            {
                Ok(v) => Ok(Value::Bool(v)),
                Err(e) => Err(e.to_string()),
        ...
        "copilot_start_device_flow" => {
            let github_domain = req
                .args
                .get("githubDomain")
                .and_then(|v| v.as_str())
                .map(|s| s.to_string());
            match cc_switch_core::commands::copilot::copilot_start_device_flow(
                &app_state,
        ...
        // ----- Codex OAuth 命令（2 个）-----
        "get_codex_oauth_quota" => get_codex_oauth_quota_inner(proxy_auth_state, req).await,
        "get_codex_oauth_models" => get_codex_oauth_models_inner(proxy_auth_state, req).await,
        // ----- 通用 Auth 命令（7 个）-----
        ...
        "reset_circuit_breaker" => {
            ...
            let app_type = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::proxy::reset_circuit_breaker(
                &app_state,
                &provider_id,
                &app_type,
            )
        ...
        "queryProviderUsage" => {
            ...
            match app.parse::<cc_switch_core::app_config::AppType>() {
                Ok(app_type) => match cc_switch_core::commands::provider::query_provider_usage(
                    &app_state,
                    &provider_id,
                    &app,
                )
        ...
        "open_provider_terminal" => {
            ...
            let cwd = req
                ...
                .and_then(|v| v.as_str())
                .map(|s| s.to_string());
            match cc_switch_core::commands::misc::open_provider_terminal(
                &app_state,
                &app,
                &provider_id,
                cwd.as_deref(),
        ...
        "delete_env_vars" => {
            ...
            match serde_json::from_value::<Vec<cc_switch_core::services::env_checker::EnvConflict>>(
                conflicts_value,
            ) {
        ...
        "probe_tool_installations" => {
            ...
            match serde_json::from_value::<Vec<String>>(tools_value) {
                Ok(tools) => {
                    match cc_switch_core::commands::misc::probe_tool_installations(tools).await {
                        Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                        Err(e) => Err(e.to_string()),
                    }
                }
        ...
        "run_tool_lifecycle_action" => {
            ...
            match serde_json::from_value::<Vec<String>>(tools_value) {
                Ok(tools) => {
                    match cc_switch_core::commands::misc::run_tool_lifecycle_action(tools, action)
                        .await
                    {
                        Ok(()) => Ok(Value::Bool(true)),
                        Err(e) => Err(e.to_string()),
        ...
        "stream_check_provider" => {
            ...
            match app.parse::<cc_switch_core::app_config::AppType>() {
                Ok(app_type) => {
                    match cc_switch_core::commands::stream_check::stream_check_provider(
                        &app_state,
                        app_type,
                        &provider_id,
                    )
        ...
        "stream_check_all_providers" => {
            ...
            match app.parse::<cc_switch_core::app_config::AppType>() {
                Ok(app_type) => {
                    match cc_switch_core::commands::stream_check::stream_check_all_providers(
                        &app_state,
                        app_type,
                        proxy_targets_only,
                    )
        ...
        "get_coding_plan_quota" => {
            ...
            let secret_access_key = req
                ...
                .and_then(|v| v.as_str())
                .map(|s| s.to_string());
            let coding_plan_provider = req
                .args
                .get("codingPlanProvider")
                .and_then(|v| v.as_str())
                .map(|s| s.to_string());
            let team_organization_id = req
                .args
                .get("teamOrganizationId")
                .and_then(|v| v.as_str())
                .map(|s| s.to_string());
            let team_project_id = req
                .args
                .get("teamProjectId")
                .and_then(|v| v.as_str())
                .map(|s| s.to_string());
        ...
        "get_session_messages" => {
            ...
            match tokio::task::spawn_blocking(move || {
                cc_switch_core::commands::session_manager::get_session_messages(
                    &provider_id,
                    &source_path,
                )
            })
        ...
        "delete_session" => {
            ...
            let source_path = req
                ...
                .to_string();
            match tokio::task::spawn_blocking(move || {
                cc_switch_core::commands::session_manager::delete_session(
                    &provider_id,
                    &session_id,
                    &source_path,
                )
        ...
        "delete_sessions" => {
            ...
            match serde_json::from_value::<Vec<cc_switch_core::session_manager::DeleteSessionRequest>>(
                items_value,
            ) {
                Ok(items) => {
                    match tokio::task::spawn_blocking(move || {
        ...
        "get_request_logs" => {
            ...
            let page_size = req
                ...
                .and_then(|v| v.as_u64())
                .unwrap_or(20) as u32;
            match serde_json::from_value::<cc_switch_core::services::usage_stats::LogFilters>(
                filters_value,
            ) {
                Ok(filters) => match cc_switch_core::commands::usage::get_request_logs(
        ...
        "get_model_pricing" => match cc_switch_core::commands::usage::get_model_pricing(&db) {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        "update_model_pricing" => {
            ...
            let output_cost = req
                ...
                .unwrap_or("0")
                .to_string();
            let cache_read_cost = req
                .args
                .get("cacheReadCost")
                .and_then(|v| v.as_str())
                .unwrap_or("0")
                .to_string();
            let cache_creation_cost = req
                .args
        ...
        "check_provider_limits" => {
            ...
            let app_type = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::usage::check_provider_limits(
                &db,
                &provider_id,
                &app_type,
            ) {
        ...
        "get_mcp_servers" => match cc_switch_core::commands::mcp::get_mcp_servers(&app_state) {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        "upsert_mcp_server" => {
        ...
        "toggle_mcp_app" => {
            ...
            let enabled = req
                ...
                .and_then(|v| v.as_bool())
                .unwrap_or(false);
            match cc_switch_core::commands::mcp::toggle_mcp_app(
                &app_state, &server_id, &app, enabled,
            ) {
                Ok(()) => Ok(Value::Bool(true)),
                Err(e) => Err(e.to_string()),
            }
        }
        "get_claude_mcp_status" => match cc_switch_core::commands::mcp::get_claude_mcp_status() {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        "read_claude_mcp_config" => match cc_switch_core::commands::mcp::read_claude_mcp_config() {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        ...
        "read_mcp_servers_map" => match cc_switch_core::commands::mcp::read_mcp_servers_map() {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        ...
        "upsert_prompt" => {
            ...
            match req.args.get("prompt") {
                Some(v) => {
                    match serde_json::from_value::<cc_switch_core::prompt::Prompt>(v.clone()) {
                        Ok(prompt) => match cc_switch_core::commands::prompt::upsert_prompt(
                            &app_state, &app, &id, prompt,
                        ) {
                            Ok(()) => Ok(Value::Bool(true)),
                            Err(e) => Err(e.to_string()),
                        },
        ...
        "get_profiles" => match cc_switch_core::commands::profile::get_profiles(&app_state) {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        "create_profile" => {
        ...
        "update_profile" => {
            ...
            let name = req
                ...
                .and_then(|v| v.as_str())
                .map(|s| s.to_string());
            let resnapshot = req.args.get("resnapshot").and_then(|v| v.as_bool());
            let scope = req.args.get("scope").and_then(|v| v.as_str());
            match cc_switch_core::commands::profile::update_profile(
                &app_state, &id, name, resnapshot, scope,
            ) {
                Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                Err(e) => Err(e.to_string()),
            }
        ...
        "get_app_config_path" => match cc_switch_core::commands::config::get_app_config_path() {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        "get_config_snippet" => {
        ...
        "test_api_endpoints" => {
            let urls = req
                ...
                .unwrap_or_default();
            let timeout_secs = req.args.get("timeoutSecs").and_then(|v| v.as_u64());
        ...
        "get_skill_backups" => match cc_switch_core::commands::skill::get_skill_backups() {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        "delete_skill_backup" => {
        ...
        "get_skill_repos" => match cc_switch_core::commands::skill::get_skill_repos(&db) {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        "add_skill_repo" => match req.args.get("repo") {
            Some(v) => match serde_json::from_value::<cc_switch_core::services::skill::SkillRepo>(
                v.clone(),
            ) {
        ...
        "install_skills_from_zip" => {
            ...
            let current_app = req
                ...
                .unwrap_or("claude")
                .to_string();
            match cc_switch_core::commands::skill::install_skills_from_zip(
                &db,
                &file_path,
                &current_app,
            ) {
        ...
        "migrate_skill_storage" => match req.args.get("target") {
            Some(v) => match serde_json::from_value::<
                cc_switch_core::services::skill::SkillStorageLocation,
            >(v.clone())
            {
                Ok(target) => {
                    match cc_switch_core::commands::skill::migrate_skill_storage(&db, target) {
                        Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                        Err(e) => Err(e.to_string()),
                    }
                }
        ...
        "save_stream_check_config" => match req.args.get("config") {
            Some(v) => match serde_json::from_value::<
                cc_switch_core::services::stream_check::StreamCheckConfig,
            >(v.clone())
            {
                Ok(config) => {
                    match cc_switch_core::commands::stream_check::save_stream_check_config(
                        &db, config,
                    ) {
                        Ok(()) => Ok(Value::Bool(true)),
                        Err(e) => Err(e.to_string()),
        ...
        "get_upstream_proxy_status" => Ok(serde_json::to_value(
        ...
        "read_omo_local_file" => match cc_switch_core::commands::omo::read_omo_local_file() {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        ...
        "disable_current_omo" => match cc_switch_core::commands::omo::disable_current_omo(&db) {
            Ok(()) => Ok(Value::Bool(true)),
            Err(e) => Err(e.to_string()),
        },
        ...
        "get_available_providers_for_failover" => {
            let app_type = req
                ...
                .unwrap_or("claude")
                .to_string();
            match cc_switch_core::commands::failover::get_available_providers_for_failover(
                &db, &app_type,
            ) {
                Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                Err(e) => Err(e.to_string()),
        ...
        "add_to_failover_queue" => {
            ...
            let provider_id = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::failover::add_to_failover_queue(
                &db,
                &app_type,
                &provider_id,
            ) {
        ...
        "remove_from_failover_queue" => {
            ...
            let provider_id = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::failover::remove_from_failover_queue(
                &db,
                &app_type,
                &provider_id,
            ) {
        ...
        "get_auto_failover_enabled" => {
            let app_type = req
                ...
                .unwrap_or("claude")
                .to_string();
            match cc_switch_core::commands::failover::get_auto_failover_enabled(&db, &app_type)
                .await
            {
                Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                Err(e) => Err(e.to_string()),
        ...
        "set_auto_failover_enabled" => {
            ...
            let enabled = req
                ...
                .and_then(|v| v.as_bool())
                .unwrap_or(false);
            match cc_switch_core::commands::failover::set_auto_failover_enabled(
                &app_state, &app_type, enabled,
            )
            .await
            {
        ...
        "set_proxy_takeover_for_app" => {
            ...
            let enabled = req
                ...
                .and_then(|v| v.as_bool())
                .unwrap_or(false);
            match cc_switch_core::commands::proxy::set_proxy_takeover_for_app(
                &proxy_service,
                &app_type,
                enabled,
            )
        ...
        "update_proxy_config" => match req.args.get("config") {
            Some(v) => {
                match serde_json::from_value::<cc_switch_core::proxy::ProxyConfig>(v.clone()) {
                    Ok(config) => match cc_switch_core::commands::proxy::update_proxy_config(
                        &proxy_service,
                        config,
                    )
                    .await
        ...
        "update_global_proxy_config" => match req.args.get("config") {
            Some(v) => {
                match serde_json::from_value::<cc_switch_core::proxy::GlobalProxyConfig>(v.clone())
                {
                    Ok(config) => {
                        match cc_switch_core::commands::proxy::update_global_proxy_config(
                            &app_state, config,
                        )
                        .await
                        {
        ...
        "get_proxy_config_for_app" => {
            let app_type = req
                ...
                .unwrap_or("claude")
                .to_string();
            match cc_switch_core::commands::proxy::get_proxy_config_for_app(&app_state, &app_type)
                .await
            {
                Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                Err(e) => Err(e.to_string()),
        ...
        "update_proxy_config_for_app" => match req.args.get("config") {
            Some(v) => {
                match serde_json::from_value::<cc_switch_core::proxy::AppProxyConfig>(v.clone()) {
                    Ok(config) => {
                        match cc_switch_core::commands::proxy::update_proxy_config_for_app(
                            &app_state, config,
                        )
                        .await
                        {
        ...
        "get_default_cost_multiplier" => {
            let app_type = req
                ...
                .unwrap_or("claude")
                .to_string();
            match cc_switch_core::commands::proxy::get_default_cost_multiplier(
                &app_state, &app_type,
            )
            .await
            {
        ...
        "set_default_cost_multiplier" => {
            ...
            let value = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::proxy::set_default_cost_multiplier(
                &app_state, &app_type, &value,
            )
            .await
            {
                Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
        ...
        "get_pricing_model_source" => {
            let app_type = req
                ...
                .unwrap_or("claude")
                .to_string();
            match cc_switch_core::commands::proxy::get_pricing_model_source(&app_state, &app_type)
                .await
            {
                Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                Err(e) => Err(e.to_string()),
        ...
        "set_pricing_model_source" => {
            ...
            let value = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::proxy::set_pricing_model_source(
                &app_state, &app_type, &value,
            )
            .await
            {
        ...
        "is_proxy_running" => Ok(serde_json::to_value(
            cc_switch_core::commands::proxy::is_proxy_running(&proxy_service).await,
        )
        .unwrap_or(Value::Null)),
        ...
        "switch_proxy_provider" => {
            ...
            let provider_id = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::proxy::switch_proxy_provider(
                &app_state,
                &app_type,
                &provider_id,
            )
        ...
        "get_provider_health" => {
            ...
            let provider_id = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::proxy::get_provider_health(
                &app_state,
                &provider_id,
                &app_type,
            )
        ...
        "update_circuit_breaker_config" => match req.args.get("config") {
            Some(v) => match serde_json::from_value::<cc_switch_core::proxy::CircuitBreakerConfig>(
                v.clone(),
            ) {
                Ok(config) => match cc_switch_core::commands::proxy::update_circuit_breaker_config(
                    &app_state, config,
                )
                .await
                {
        ...
        "get_circuit_breaker_stats" => {
            ...
            let provider_id = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::proxy::get_circuit_breaker_stats(
                &app_state,
                &provider_id,
                &app_type,
            )
        ...
        "get_init_error" => match cc_switch_core::commands::misc::get_init_error_command() {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        "get_migration_result" => match cc_switch_core::commands::misc::get_migration_result() {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
                ...
                match serde_json::from_value::<cc_switch_core::settings::S3SyncSettings>(
                    ...
                    Ok(settings) => {
                        let password_touched =
                            req.args.get("passwordTouched").and_then(|v| v.as_bool());
        ...
        "delete_mcp_server_in_config" => {
            ...
            let id = req
                ...
                .unwrap_or("")
                .to_string();
            match cc_switch_core::commands::mcp::delete_mcp_server_in_config(&app_state, &app, &id)
            {
                Ok(v) => Ok(Value::Bool(v)),
                Err(e) => Err(e.to_string()),
            }
        ...
        "set_mcp_enabled" => {
            ...
            let enabled = req
                ...
                .and_then(|v| v.as_bool())
                .unwrap_or(false);
            match cc_switch_core::commands::mcp::set_mcp_enabled(&app_state, &app, &id, enabled) {
                Ok(v) => Ok(Value::Bool(v)),
                Err(e) => Err(e.to_string()),
            }
        }
        ...
        "import_openclaw_providers_from_live" => {
            match cc_switch_core::commands::openclaw::import_openclaw_providers_from_live(
                &app_state,
            ) {
                Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                Err(e) => Err(e.to_string()),
        ...
        "set_openclaw_default_model" => {
            ...
            match serde_json::from_value::<cc_switch_core::openclaw_config::OpenClawDefaultModel>(
                model_value,
            ) {
                Ok(model) => {
                    match cc_switch_core::commands::openclaw::set_openclaw_default_model(model) {
                        Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                        Err(e) => Err(e.to_string()),
                    }
                }
        ...
        "set_openclaw_model_catalog" => {
            ...
            {
                Ok(catalog) => {
                    match cc_switch_core::commands::openclaw::set_openclaw_model_catalog(catalog) {
                        Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                        Err(e) => Err(e.to_string()),
                    }
                }
        ...
        "set_openclaw_agents_defaults" => {
            ...
            match serde_json::from_value::<cc_switch_core::openclaw_config::OpenClawAgentsDefaults>(
                defaults_value,
            ) {
                Ok(defaults) => {
                    match cc_switch_core::commands::openclaw::set_openclaw_agents_defaults(defaults)
                    {
                        Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
                        Err(e) => Err(e.to_string()),
                    }
        ...
        "get_openclaw_env" => match cc_switch_core::commands::openclaw::get_openclaw_env() {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        "set_openclaw_env" => {
            let env_value = req.args.get("env").cloned().unwrap_or(Value::Null);
            match serde_json::from_value::<cc_switch_core::openclaw_config::OpenClawEnvConfig>(
                env_value,
            ) {
        ...
        "get_openclaw_tools" => match cc_switch_core::commands::openclaw::get_openclaw_tools() {
            Ok(v) => Ok(serde_json::to_value(v).unwrap_or(Value::Null)),
            Err(e) => Err(e.to_string()),
        },
        "set_openclaw_tools" => {
            let tools_value = req.args.get("tools").cloned().unwrap_or(Value::Null);
            match serde_json::from_value::<cc_switch_core::openclaw_config::OpenClawToolsConfig>(
                tools_value,
            ) {
...
async fn upload_handler(mut multipart: Multipart) -> Response {
    let field = match multipart.next_field().await {
        Ok(Some(field)) => field,
        Ok(None) => return (StatusCode::BAD_REQUEST, "未收到上传文件").into_response(),
        Err(e) => {
            return (StatusCode::BAD_REQUEST, format!("读取上传请求失败: {e}")).into_response();
        }
    };
    let file_name = field
        .file_name()
    ...
    let data = match field.bytes().await {
        Ok(b) => b,
        Err(e) => {
            return (StatusCode::BAD_REQUEST, format!("读取上传数据失败: {e}")).into_response();
        }
    };
...
async fn download_handler(Path(filename): Path<String>) -> Response {
    ...
    let data = match std::fs::read(&path) {
        Ok(d) => d,
        Err(e) => {
            return (StatusCode::INTERNAL_SERVER_ERROR, format!("读取失败: {e}")).into_response()
        }
    };
...
async fn restart_handler() -> Response {
    ...
    if let Some(sender) = SHUTDOWN_SENDER.get() {
        if sender.send(()).await.is_err() {
            log::warn!("[restart] shutdown receiver is no longer available");
        }
    }
    Json(serde_json::json!({
        "success": true,
...
async fn get_codex_oauth_quota_inner(
    ...
    let token = match manager.get_valid_token_for_account(&id).await {
        ...
        Err(e) => {
            return Ok(
                serde_json::to_value(cc_switch_core::services::SubscriptionQuota::error(
                    "codex_oauth",
...
async fn auth_start_login_inner(
    ...
    match auth_provider {
        AUTH_PROVIDER_GITHUB_COPILOT => {
            ...
            Ok(
                serde_json::to_value(map_device_code_response(auth_provider, response))
                    .unwrap_or(Value::Null),
            )
        }
...
async fn auth_list_accounts_inner(
    ...
    match auth_provider {
        AUTH_PROVIDER_GITHUB_COPILOT => {
            ...
            let accounts: Vec<ManagedAuthAccount> = status
                .accounts
                .into_iter()
                .map(|a| map_account(auth_provider, a, default_account_id.as_deref()))
                .collect();
...
pub async fn startup_initialization(app_state: AppState) {
    ...
    for app_type in cc_switch_core::app_config::AppType::all().filter(|t| !t.is_additive_mode()) {
        let should_import =
            cc_switch_core::services::provider::should_import_default_config_on_startup(
                &app_state, &app_type,
            )
            .unwrap_or(false);
        if !should_import {
            log::debug!(
                "[startup] ○ {} already has providers; live import skipped",
                app_type.as_str()
            );
            continue;
        }
        match cc_switch_core::commands::provider::import_default_config(
            &app_state,
            app_type.as_str(),
        ) {
            Ok(true) => log::info!(
                "[startup] ✓ Imported live config for {} as default provider",
                app_type.as_str()
            ),
            Ok(false) => log::debug!(
                "[startup] ○ {} already has providers; live import skipped",
            ...
            Err(e) => log::debug!(
                "[startup] ○ No live config to import for {}: {e}",
                app_type.as_str()
            ),
        }
    }
    ...
    // 4. OMO 配置导入
    {
        ...
        if !has_omo {
            match cc_switch_core::services::OmoService::import_from_local(
                ...
                Ok(provider) => {
                    log::info!("[startup] ✓ Imported OMO config as '{}'", provider.name)
                }
                Err(cc_switch_core::AppError::OmoConfigNotFound) => {
                    log::debug!("[startup] ○ No OMO config to import")
                }
        ...
        if !has_omo_slim {
            match cc_switch_core::services::OmoService::import_from_local(
                ...
                Ok(provider) => log::info!(
                    "[startup] ✓ Imported OMO Slim config as '{}'",
                    provider.name
                ),
                Err(cc_switch_core::AppError::OmoConfigNotFound) => {
                    log::debug!("[startup] ○ No OMO Slim config to import")
                }
    ...
    if db.is_mcp_table_empty().unwrap_or(false) {
        ...
        match cc_switch_core::services::McpService::import_from_all_apps(&app_state) {
            Ok(count) if count > 0 => {
                log::info!("[startup] ✓ Imported {count} MCP server(s) total")
            }
    ...
    if db.is_prompts_table_empty().unwrap_or(false) {
        ...
        for app in [
            ...
            match cc_switch_core::services::PromptService::import_from_file_on_first_launch(
                &app_state,
                app.clone(),
            ) {
                Ok(count) if count > 0 => log::info!(
                    "[startup] ✓ Imported {count} prompt(s) for {}",
                    app.as_str()
                ),
                Ok(_) => log::debug!("[startup] ○ No prompt file for {}", app.as_str()),
                Err(e) => log::warn!(
                    "[startup] ✗ Failed to import prompt for {}: {e}",
                    app.as_str()
                ),
            }
        }
